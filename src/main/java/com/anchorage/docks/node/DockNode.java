...
public class DockNode extends StackPane implements DockContainableComponent {
    ...
    private ReadOnlyBooleanWrapper dockingCapability;
    ...
    private DockNode() {
        ...
        dockingCapability = new ReadOnlyBooleanWrapper(true);
    ...
    public ReadOnlyBooleanProperty dockingCapabilityProperty() {
    	return dockingCapability.getReadOnlyProperty();
    }
    ...
    /**
     * Disable the capability to dock this node, somewhere else, by removing its title pane
     * @warn can not be re-done
     */
    public void disableDockCapability(){
    	content.disableDockCapability();
    	dockingCapability.set(false);
    }
    ...
    public void setParentContainer(DockContainer container) {
        ...
        if (container != null)
        	fireEvent(new DockNodeEvent(this, DockNodeEvent.DOCK_NODE_DOCKED));
    }
